...
public abstract class MiniComponent {
    ...
    public static final String DIR_MINITOUCH = ROOT + File.separator + MINITOUCH + File.separator;
...
//    public static final String DIR_MINICAP = ROOT + File.separator + MINICAP + File.separator;
    ...
    // TODO
    public static final String DIR_MINICAP_SHARE = ROOT + File.separator + MINICAP + File.separator
