...
public class StfAgent {
    ...
    private static final String PATH_SERVICE_APK = MiniComponent.ROOT + File.separator + "qop-main" + File.separator +
            "bin" + File.separator + "apk" + File.separator + "STFService.apk";
